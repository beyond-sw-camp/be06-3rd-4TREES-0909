<template>
    ...
    <div id="main_content">
        ...
        <section class="goods_form">
            <h2>입찰 수정 <span class="red">*필수항목</span></h2>
            <form action="" class="frm_selling_goods">
                ...
                <div class="goods_price_area">
                    ...
                    <div class="goods_price">
                        <p><input type="text" name="goodsPrice" placeholder="숫자만 입력해주세요" v-model="bidPrice" @input="valueIsNumber" @focus="resetPrice">원</p>
                    </div>
                </div>
            </form>
        </section>
    ...
    <div class="btn_submit_area">
        <div class="inner_submit">
            ...
            <input type="button" class="btn_goods_submit" @click="bidModify()" value="수정하기">
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        async bidModify() {
            ...
            const response = await this.bidStore.modifyBid(this.bidIdx, this.productIdx, this.bidPrice);
            if (response.data.isSuccess){
                alert('입찰 수정이 정상적으로 완료되었습니다.');    
            } else{
                alert('입찰 수정을 완료하지 못했습니다. 다시 시도해주세요.');
            }
    ...
    mounted() {
        this.bidIdx = this.$route.query.bidIdx;
