            ...
            <nav class="aside-menu">
                <ul class="menu-list">
                    ...
                    <li>
                        ...
                        <ul class="depth2">
                            <li><a class="left-sidebar" href="#" @click="showAlert">주문내역</a></li>
                            <li>
                                <a class="left-sidebar" href="#" @click="showAlert">취소/반품 내역</a>
                            </li>
                        </ul>
                    </li>
                    <li>
...
.aside-menu .menu-list > li .depth2 {
    margin-top: 8px;
}
...
.aside-menu .menu-list > li .depth2 > li {
    font-size: 14px;
    color: #666;
}
