    ...
    <div class="css-5cgeed">
        <div class="css-qdwe4u">
            ...
            <div v-else class="css-8knsro"><router-link  :to="`/groupbuy/detail/wait/${selectGpbuyIdx}`">
                <button type="button" class="css-16iku8x">입찰 정보 보기</button></router-link>
            </div>
                    ...
                    <form>
                        <div class="css-17t0ez6">
                            <div class="css-xrnbd4">
                                <div class="css-prvn4i"><label for="name" class="css-8840p9">공구명</label><input v-bind="gpbuyTitle"
                                ...
                                <button type="button" class="css-10q122i" @click="search">검색하기</button>
                            </div>
                        </div>
                    </form>
                        ...
                        <div class="css-1n7cno0">
                            <table role="table" class="css-1dfxxj6">
                                        ...
                                        <th class="table-column css-7y20gd" colspan="1" role="columnheader"
                                            ...
                                            <div class="css-1wnowod"><label class="css-u2o9sw"><svg
                                                        ...
                                                        <path fill="#E5E5E5" fill-rule="evenodd"
                                                            ...
                                                            clip-rule="evenodd"></path>
                                                    </svg><input type="radio" title="Toggle All Rows Selected"
                                ...
                                <tbody v-else role="rowgroup">
                                    <MyWaitGroupbuyComponent v-for="(waitGroupbuy,idx) in groupbuyStore.myWaitGroupbuyList" :key="idx" :waitGroupbuy="waitGroupbuy" 
                                    @update-select-groupbuy="handleSelectGroupbuy"></MyWaitGroupbuyComponent>
                                </tbody>
                            </table>
                        </div>
...
<script>
import MyWaitGroupbuyComponent from './MyWaitGroupbuyComponent.vue';
...
export default {
    ...
    methods: {
        async getMyWaitGroupbuyList() {
            await this.groupbuyStore.getMyWaitGroupbuyList();
            this.isLoading=false;
        },
        handleSelectGroupbuy(newIdx){
            this.selectGpbuyIdx = newIdx;
        }
    },
    mounted() {
        this.getMyWaitGroupbuyList();
    }
}
</script>
