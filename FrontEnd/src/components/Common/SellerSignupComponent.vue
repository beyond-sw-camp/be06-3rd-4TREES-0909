<template>
    <div class="contentWrapper registContent">
            ...
            <div class="uInputArea emailType">
                <div class="col">
                    <div class="uInput">
                        ...
                        <div class="inputBox">
                            <input type="text" id="inputEmail" class="inputText" tabindex="5" v-model="seller.email"
                                @input="validateEmail">
                        </div>
                    </div>
                </div>
            ...
            <div class="uInputArea">
                <div class="col">
                    <div class="uInput">
                        ...
                        <div class="inputBox">
                            <input type="password" id="inputPw" class="inputText" placeholder="8~12자 영문, 숫자, 특수문자"
                                tabindex="2" v-model="seller.password" @input="validatePassword">
                    ...
                    <div class="uInput">
                        ...
                        <div class="inputBox">
                            <input type="password" id="inputPwConfirm" class="inputText"
                                placeholder="8~12자 영문, 숫자, 특수문자" tabindex="3" v-model="confirmPassword"
            ...
            <div class="uInputArea">
                <div class="col">
                    <div class="uInput">
                        ...
                        <div class="inputBox">
                            <input type="text" id="inputName" class="inputText" tabindex="4" v-model="seller.name"
                                @input="validateName">
                        </div>
                    </div>
                </div>
            ...
            <div class="uInputArea">
                <div class="col">
                    <div class="uInput">
                        ...
                        <div class="inputBox">
                            <input type="date" id="inputBirth" class="inputText" tabindex="4" v-model="seller.birth"
                ...
                <div class="col">
                    <div class="uInput">
                        ...
                        <div class="inputBox radioBox">
                            <input type="radio" id="genderMale" name="gender" value="남" v-model="seller.sex"
                                tabindex="4" @change="validateGender">
                            <label for="genderMale">남성</label>
                            <input type="radio" id="genderFemale" name="gender" value="여" v-model="seller.sex"
                                tabindex="5" @change="validateGender">
            ...
            <div class="uInputArea">
                <div class="col">
                    <div class="uInput">
                        ...
                        <div class="inputBox">
                            <input type="text" id="inputPostCode" class="inputText" tabindex="2"
                                v-model="seller.postCode" @input="validatePostCode">
                        </div>
                    </div>
                </div>
                <div class="col">
            ...
            <div class="uInputArea">
                <div class="col">
                    <div class="uInput">
                        ...
                        <div class="inputBox">
                            <input type="text" id="inputAddress" class="inputText" tabindex="4" v-model="seller.address"
            ...
            <div class="uInputArea">
                <div class="col">
                    <div class="uInput">
                        ...
                        <div class="inputBox">
                            <input type="text" id="inputDetailAddr" class="inputText" tabindex="4"
                                v-model="detailAddress" @input="validateDetailAddress">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="certBox">
                ...
                <div class="uInputArea">
                    <div class="col">
                        <div class="uInput">
                            ...
                            <div class="inputBox">
                                <input type="text" id="inputResNum" class="inputText" tabindex="4"
                                    v-model="companyVerfy.b_no" @input="validateCompanyReg">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="uInputArea">
                    <div class="col">
                        <div class="uInput">
                            ...
                            <div class="inputBox">
                                <input type="text" id="inputCEOName" class="inputText" tabindex="4"
                                    v-model="companyVerfy.p_nm" @input="validateCeoName">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="uInputArea">
                    <div class="col">
                        <div class="uInput">
                            ...
                            <div class="inputBox">
                                <input type="date" id="inputOpenDate" class="inputText" tabindex="4"
                                    v-model="companyVerfy.start_dt" @change="validateOpenedDt">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="uBtnArea"><button type="button" class="uBtn borderType" :class="{ 'verified': uuid }"
                    @click="verifySubmit"> {{ uuid ? '인증 완료' : '사업자등록번호 인증하기 (필수)' }}</button>
            </div>
        </div>
        <div class="uBlock">
            <div class="uInputArea">
                <div class="col">
                    <div class="uInput">
                        ...
                        <div class="inputBox">
                            <input type="text" id="inputMosNum" class="inputText" tabindex="4"
                                v-model="seller.sellerMosNum" @input="validateMosNum">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="uInputArea">
                <div class="col">
                    <div class="uInput">
                        ...
                        <div class="inputBox">
                            <input type="text" id="inputBankName" class="inputText" tabindex="4"
                                v-model="seller.sellerBank" @input="validateBankName">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="uInputArea">
                <div class="col">
                    <div class="uInput">
                        ...
                        <div class="inputBox">
                            <input type="text" id="inputDepoName" class="inputText" tabindex="4"
                                v-model="seller.sellerDepoName" @input="validateDepoName">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="uInputArea">
                <div class="col">
                    <div class="uInput">
                        ...
                        <div class="inputBox">
                            <input type="text" id="inputAccount" class="inputText" tabindex="4"
                                v-model="seller.sellerAccount" @input="validateAccount">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="uInputArea">
                <div class="col">
                    <div class="uInput">
                        ...
                        <div class="inputBox">
                            <input type="text" id="inputCellphone" class="inputText" placeholder="010-1234-5678"
                                tabindex="7" v-model="seller.phoneNumber" @input="validateAndFilterPhoneNumber"
                                pattern="\d*">
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        async verifySubmit() {
            ...
            if (result) {
                this.uuid = this.userStore.uuid;
            } else {
                alert("사업자등록번호 인증에 실패하였습니다. 다시 입력해주세요.");
            }
        },
        submit() {
            // - 제외
            ...
            if (result) {
                ...
                alert("업체 회원가입이 완료되었습니다. 이메일을 확인해주세요.")
